                        ...
                        <div class="flex items-center m-10 border border-gray-200 rounded shadow p-3 flex-col md:flex-row">
                            ...
                            <div class="text-gray-700 overflow-hidden ">
                                ...
                                <div class="text-sm">
                                    ...
                                    <p className="text-lg font-bold"> Education: <span className="font-thin">{doctor.experiance}</span>
                                    </p>

                                    <p className="text-lg font-bold"> experiance: <span className="font-thin"> {doctor.education}</span>
                                    </p>
